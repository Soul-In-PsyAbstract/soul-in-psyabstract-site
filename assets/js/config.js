{
  ...
  "project": {
    ...
    "canonical": "https://soulinpsyabstract.store/",
    "languages": [
      "ru",
      "en"
    ],
  ...
  "seo": {
    ...
    "json_ld": {
      "website": {
        "enabled": true,
        "name": "Soul in PsyAbstract",
        "url": "https://soulinpsyabstract.store/",
        "potentialAction": [
          {
            "@type": "SearchAction",
            "target": "https://soulinpsyabstract.store/?q={search_term_string}",
  ...
  "assets": {
    ...
    "fonts": [
      {
        "file": "/assets/fonts/Caveat-VariableFont_wght.ttf",
        "family": "Caveat",
        "weight": "100 900",
        "preload": true
      },
      {
        "file": "/assets/fonts/Pacifico-Regular.ttf",
        "family": "Pacifico",
        "weight": "400",
        "preload": true
      },
      {
        "file": "/assets/fonts/MarckScript-Regular.ttf",
        "family": "Marck Script",
        "weight": "400",
        "preload": true
      }
  ...
  "chat": {
    "tawk": {
      ...
      "property_url": "https://soulinpsyabstract.store",
  ...
  "faq_mini": {
    "ru": [
      {
        "q": "Оплата",
        "a": "PayPal Fast, PayPal.me, ETH. Эксклюзив +200 к базе. Доставка оплачивается отдельно."
      },
      {
        "q": "Доставка",
        "a": "Миром. Трекинг. Экспресс по запросу."
      },
      {
        "q": "Оригинал",
        "a": "Все работы рисуются линером. Оригиналы — уникальны."
      },
      {
        "q": "NFT",
        "a": "Только Rarible. Ссылки — на странице NFT."
      },
      {
        "q": "Право",
        "a": "Exclusive даёт единственное коммерческое использование."
      },
      {
        "q": "Размер",
        "a": "Обычно A5–A4, другие по запросу."
      },
      {
        "q": "Цвет",
        "a": "Неон/аква настроение. Мягче вживую."
      },
      {
        "q": "Возврат",
        "a": "Если посылка потерялась — верну или перешлю."
      },
      {
        "q": "Комиссия",
        "a": "Принимаю заказы на сердца и спирали по историям клиентов."
      },
      {
        "q": "Гарантия",
        "a": "Надёжная упаковка и помощь при проблемах с доставкой."
      },
      {
        "q": "Связь",
        "a": "Быстрее всего — WhatsApp или Telegram."
      },
      {
        "q": "Сроки",
        "a": "Обычно 7–14 дней до отправки."
      }
    ],
    "en": [
      {
        "q": "Payment",
        "a": "PayPal Fast, PayPal.me, ETH. Exclusive +200 USD. Shipping paid separately."
      },
      {
        "q": "Shipping",
        "a": "Worldwide, tracked, express on request."
      },
      {
        "q": "Original",
        "a": "Drawn in ink liner. Originals are one of a kind."
      },
      {
        "q": "NFT",
        "a": "Rarible only. Links on NFT page."
      },
      {
        "q": "Rights",
        "a": "Exclusive = single commercial use."
      },
      {
        "q": "Size",
        "a": "Usually A5–A4, others on request."
      },
      {
        "q": "Color",
        "a": "Neon/aqua mood. Softer in person."
      },
      {
        "q": "Returns",
        "a": "If lost, refund or reship."
      },
      {
        "q": "Commission",
        "a": "Custom hearts & spirals based on stories."
      },
      {
        "q": "Guarantee",
        "a": "Safe packaging, full support."
      },
      {
        "q": "Contact",
        "a": "Fastest: WhatsApp or Telegram."
      },
      {
        "q": "Lead time",
        "a": "Usually 7–14 days to dispatch."
      }
    ]
  },
  "build": {
  ...
  "sitemap": {
    "base_url": "https://soulinpsyabstract.store",
    "entries": [
      {
        "loc": "/htdocs/index.html",
        "priority": 1.0
      },
      {
        "loc": "/htdocs/gallery.html",
        "priority": 0.9
      },
      {
        "loc": "/htdocs/nft.html",
      ...
      {
        "loc": "/htdocs/manifest.html",
        "priority": 0.7
      },
      {
        "loc": "/htdocs/poems.html",
        "priority": 0.6
      },
      {
        "loc": "/htdocs/songs.html",
        "priority": 0.6
      },
      {
        "loc": "/htdocs/faq.html",
      ...
      {
        "loc": "/htdocs/contacts.html",
        "priority": 0.5
      },
      {
        "loc": "/htdocs/orders.html",
        "priority": 0.7
      },
      {
        "loc": "/htdocs/ai.html",
  ...
  "robots": {
    "content": "User-agent: *\nAllow: /\nDisallow: /assets/\nSitemap: https://soulinpsyabstract.store/sitemap.xml\n"
  },
  "server": {
